...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SDKInitializer.initialize(getApplicationContext());//开启地图，传入一个Context全局对象，必须在setContentView前调用
        ...
        if (!permissionList.isEmpty()) {
            ...
            ActivityCompat.requestPermissions(MainActivity.this, permissions, 1);//申请访问权限
        } else {
            requestLocation();
        }
